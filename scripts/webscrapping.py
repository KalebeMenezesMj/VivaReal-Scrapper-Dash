...
URL_LISTAGEM = "https://www.vivareal.com.br/venda/sp/ilha-comprida/apartamento_residencial/?transacao=venda&onde=%2CS%C3%A3o+Paulo%2CIlha+Comprida%2C%2C%2C%2C%2C%2Ccity%2CBR%3ESao+Paulo%3ENULL%3EIlha+Comprida%2C-24.740623%2C-47.536813%2C&tipos=apartamento_residencial%2Ccondominio_residencial%2Cflat_residencial%2Ckitnet_residencial"
        ...
        while True:
            ...
            try:
                ...
                if not next_button.is_enabled():
                    print(Fore.GREEN + "Botão 'Próxima página' desabilitado. Fim da navegação.")
                    break
                ...
                print(Fore.GREEN + "Botão 'Próxima página' não encontrado. Fim da navegação.")
                break
            except Exception as e:
...
if __name__ == "__main__":
    ...
    if not new_links_to_process:
        ...
        print(Fore.CYAN + "Iniciando scraping paralelo com 4 workers...")
